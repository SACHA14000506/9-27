...
def get_diffusion_features(repo_path, branch, csv_file='commit_ids.csv'):
    """
...
def save_diffusion_features(diffusion_features, path=f"diffusion_features{suffix_num}.csv"):
    """
    将扩散特征保存到CSV文件。
    """
